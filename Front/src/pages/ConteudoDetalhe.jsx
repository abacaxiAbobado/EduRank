...
export default function ConteudoDetalhe() {
  ...
  return (
    <div style={{ display: 'flex' }}>
      <Sidebar />
      <main style={{ marginLeft: 240, flex: 1, padding: 32, minHeight: '100vh', boxSizing: 'border-box', overflow: 'hidden' }}>
        ...
        {loading ? (
          ...
          <>
            ...
            <h1 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: '2rem', marginBottom: 8 }}>{conteudo.titulo}</h1>
            {conteudo.descricao && (
